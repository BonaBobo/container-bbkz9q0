...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bbkz9q0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bbkz9q0.containers.anotherwebservice.com/
...
```
git clone git@github.com:BonaBobo/container-bbkz9q0.git
cd container-bbkz9q0
```
...
```
docker attach container-bbkz9q0
```
